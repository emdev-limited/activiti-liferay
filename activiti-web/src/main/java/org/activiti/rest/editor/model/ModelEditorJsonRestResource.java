...
//          byte[] extraBytes = repositoryService.getModelEditorSourceExtra(model.getId());
//          if (extraBytes != null && extraBytes.length > 0) {
//        	  ObjectNode editorJsonExtraNode = (ObjectNode) objectMapper.readTree(new String(extraBytes, "utf-8"));
//              modelNode.put("modelExtra", editorJsonExtraNode);
//          }
