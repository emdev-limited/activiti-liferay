...
import org.activiti.rest.api.exceptions.NotImplementedException;
  ...
  public ObjectNode executeTaskOperation(Representation entity) {
    ...
    try {
      ...
      if ("claim".equals(operation)) {
        ...
        throw new NotImplementedException("'" + operation + "' is not a valid operation");
      }
      
    } catch(Exception e) {
      throw new BadRequestException("Did not receive the operation parameters", e);
    }
