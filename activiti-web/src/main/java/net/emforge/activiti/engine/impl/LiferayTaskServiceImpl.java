 ...
 * 
 */
@Service(value="liferayTaskService")
public class LiferayTaskServiceImpl implements LiferayTaskService {
	...
	public void addWorkflowLogEntry(String taskId, String processInstance, WorkflowLogEntry workflowLogEntry) {
		...
		taskService.getCommandExecutor().execute(new AddWorkflowLogEntryCmd(taskId, processInstance,
				workflowLogEntry));
	}
}
