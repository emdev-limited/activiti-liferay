...
import org.activiti.engine.impl.cmd.AbstractSetProcessDefinitionStateCmd;
 ...
 * @author Joram Barrez
 */
public class DeleteProcessDefinitionCmd extends AbstractSetProcessDefinitionStateCmd {
  
  public DeleteProcessDefinitionCmd(ProcessDefinitionEntity processDefinitionEntity, 
  ...
  public DeleteProcessDefinitionCmd(String processDefinitionId, String processDefinitionKey, 
          boolean includeProcessInstances, Date executionDate, String tenantId) {
